...
published: false
layout:     post
title:      "对中国用户而言，Pure Android 是否�?MIUI �?Flyme 体验更好�?
subtitle:   ""
...
<p>哎呀～不要站队嘛。其实这是一个很有意思的题目，让我们一点点来看
    ...
    <br>
    <br><b>否。（</b><b>对中国用户而言，Pure Android 并不�?MIUI �?Flyme 体验更好�?/b><b>�?/b>
    ...
    <ul>
        <li><b>为什�?Geek 用户 都爱使用Pure Android？：</b>
        </li>
    ...
    <br>
    <br><b>因为这群人是Geek呀�?/b>这群谷粉、安卓粉、IT科技粉、设计师、工程师们，这群充满技术情节的人儿们，为了我们的品味（逼格），挂着VPN，连着美版的Play Store，用着Android/Material Design �?GMS，Chrome Beta，FB，Twitter，WhatsApp……就这么一路高歌的走下去了�?
    <br>
    <br>你看！Action Bar �?Navigation Drawer 多好用！
    <br>你看！Fixed Tabs 可以滑的好吗�?
    <br>你看！流畅不！ART开起来妥妥的流畅度爆iOS�?
    <br>你看！原生Android 哪里会越用用卡！？你�?.4.4了吗 �?
    <br>
    ...
    <ul>
        <li><b>为什�?非Geek 用户 不适合使用Pure Android？：</b>
        </li>
    ...
    <br>
    <ul>
        <li>国外规范�?Android Design 生态环境打造统一�?Pure Android 体验</li>
        <li>更高级的手势/App运用带来了很多便利（典型的例子SwipePad�?/li>
        <li>有着工程师思想的他们可以轻易理解Android的复杂逻辑</li>
        <li>有着工程师思想的他们总能自己轻松躲开一些设计问�?/li>
    </ul>
    <br>�?Pure Android 之于 普通用�?呢？
    ...
    </ul><b>不够酷？</b>对大部分用户来说够酷�?
    <br>
    <ul>
        <li>小米，平板，盒子，电视，路由……MIUI的多屏体�?/li>
    ...
    <br>所以我的结论是�?
    <br>
    <br><b>对中国用户而言，Pure Android 并不�?MIUI �?Flyme 体验更好�?/b>
    <br><b>对大部分中国用户而言，MIUI �?Flyme �?</b><b>Pure Android �?/b><b>体验更好�?/b>
    <br>
    <br>
    <br>
    <br>
